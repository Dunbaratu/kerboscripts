// A Variant of simple_launch_example, but with values tweaked
// for mun launch not kerbin.
...
local cutoff_ap is 25_000.
local min_pe is 20_000. // min safe Pe because of atmo.
local payload_cut_pe is 1000000000. // don't trigger this.
