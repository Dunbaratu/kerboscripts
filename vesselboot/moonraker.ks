...
lock throttle to 1.
lock steering to HEADING(which_comp(),86).
...
lock throttle to 0. stage. wait 0.8. wait until stage:ready. lock throttle to 1. stage. wait 0.8. wait until stage:ready. stage. lock throttle to 1.
...
stage. wait 1. rcs on. stage.
lock steering to prograde.
wait 15.
set ship:control:fore to 1.
wait 3.
lock throttle to 1. stage.
print "waiting for Ap = Moon Ap = " + Moon:apoapsis.
wait until apoapsis > moon:apoapsis.
lock throttle to 0.
print "engine cut".
